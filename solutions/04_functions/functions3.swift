...
func calculateInterest(principal: Double, rate: Double = 1.0, years: Int) -> Double {
...
func main() {
    print("interest \(calculateInterest(principal: 1000, years: 2)), sum \(sum(numbers: 1, 2, 3, 4, 5)), join \(joinWords(words: ["Hello", "World"]))")
    ...
    test("Sum variadic parameters") {
        ...
        assertEqual(sum(), 0, "No numbers should return 0")
    }
